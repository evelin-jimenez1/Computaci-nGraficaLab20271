...
void dibujarCubo(GLint modelLoc, glm::vec3 posicion, float angulo, glm::vec3 ejeRotacion, glm::vec3 escala) {
...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindVertexArray(VAO);
		//parametros traslacion, angulo, rotacion y escala. De ellos dependen cada coordenada, los parametros es cada coordenada
		// Cubo 1: Centro, tamaño normal, sin rotación
		dibujarCubo(modelLoc, glm::vec3(0.0f, 0.0f, 0.0f), 10.0f, glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f));

		// Cubo 2: Arriba a la derecha, rotado 45 grados, a la mitad de tamaño
		dibujarCubo(modelLoc, glm::vec3(2.5f, 2.0f, -2.0f), 45.0f, glm::vec3(0.5f, 1.0f, 0.0f), glm::vec3(0.5f, 0.5f, 0.5f));

		// Cubo 3: Abajo a la izquierda, rotado 60 grados en Z, deformado (escala no uniforme)
		dibujarCubo(modelLoc, glm::vec3(-3.0f, -1.5f, -1.0f), 60.0f, glm::vec3(0.0f, 0.0f, 1.0f), glm::vec3(1.5f, 0.5f, 1.0f));

		// Cubo 4: Abajo a la derecha, rotado -30 grados, escalado uniformemente
		dibujarCubo(modelLoc, glm::vec3(3.0f, -2.5f, -4.0f), -30.0f, glm::vec3(1.0f, 1.0f, 1.0f), glm::vec3(0.8f, 0.8f, 0.8f));
